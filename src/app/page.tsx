    ...
    <section className="space-y-8">
      ...
      <div className="max-w-lg mx-auto">
        <div className="relative group">
          ...
          <div className="absolute inset-y-0 right-0 pr-4 flex items-center pointer-events-none">
            <svg className="h-6 w-6 text-dark-green-400 group-hover:text-vibrant-orange-500 transition-colors duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          {/* Search Suggestions */}
          {searchTerm.length > 0 && (
            <div className="absolute top-full left-0 right-0 mt-2 bg-white rounded-2xl shadow-strong border border-dark-green-100 overflow-hidden z-10 animate-in slide-in-from-top-2 duration-200">
              <div className="p-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {filteredListings.map((listing) => (
          <Card key={listing.id} className="group cursor-pointer transition-all duration-500 hover:-translate-y-2 hover:shadow-strong overflow-hidden">
            <CardContent className="p-0">
              {/* Image Placeholder with Enhanced Hover */}
              <div className="relative aspect-[4/3] rounded-t-2xl bg-gradient-to-br from-light-beige-100 to-light-beige-200 mb-4 flex items-center justify-center group-hover:from-light-beige-200 group-hover:to-light-beige-300 transition-all duration-500 overflow-hidden">
                ...
                {/* Hover Overlay */}
                <div className="absolute inset-0 bg-gradient-to-t from-dark-green-600/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                ...
                <div className="absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-2 group-hover:translate-y-0">
                  <button className="w-8 h-8 bg-white/90 backdrop-blur-sm rounded-full flex items-center justify-center shadow-medium hover:bg-white transition-all duration-200 hover:scale-110">
                    <svg className="w-4 h-4 text-dark-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="px-6 pb-6 space-y-4">
                <h3 className="font-semibold text-xl text-dark-green-600 leading-tight group-hover:text-vibrant-orange-600 transition-colors duration-300">
                  {listing.title}
                </h3>
                
                <div className="flex items-center justify-between">
                  <span className="font-bold text-2xl text-vibrant-orange-500 group-hover:scale-105 transition-transform duration-300">
                    {listing.price}
                  </span>
                  <div className="flex items-center gap-1 text-dark-green-500 text-sm font-medium">
                ...
                <div className="flex items-center justify-between">
                  <span className="inline-flex items-center px-3 py-1.5 bg-warm-yellow-100 text-dark-green-700 text-sm font-medium rounded-full border border-warm-yellow-200 group-hover:bg-warm-yellow-200 group-hover:border-warm-yellow-300 transition-all duration-200">
                    {listing.condition}
                  </span>
                  <button className="flex items-center gap-1 text-vibrant-orange-500 hover:text-vibrant-orange-600 font-medium text-sm transition-all duration-200 hover:gap-2 group-hover:gap-2">
                    View Details 
